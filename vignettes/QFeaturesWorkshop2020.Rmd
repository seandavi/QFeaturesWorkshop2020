...
vignette: >
  ...
  %\VignettePackage{QFeaturesWorkshop2020}
  %\VignetteDepends{QFeatures,tidyvers,limma,factoextra,patchwork,BiocStyle}
---
...
start by loading the `tidyvers` and `QFeatures` packages.
...
As below shows, it is possible to substantially improve these results
...
knitr::include_graphics("./figs/vp2.svg")
```
